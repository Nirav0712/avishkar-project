      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 justify-items-center">
          ...
          {visiblePartners.map((partner, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-md p-6 text-center w-42.5 transition duration-300 hover:shadow-xl  hover:border-[#e4c272] hover:-translate-y-1"
            >

              {/* Logo */}
              <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-[#0f1f3d]/70 flex items-center justify-center">
              ...
              {/* Name */}
              <h3 className="text-md font-bold text-[#0f1f3d]">
                {partner.name}
              </h3>
